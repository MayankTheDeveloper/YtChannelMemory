...
def shorts_recommendation_node(state: ChannelAnalysisState) -> ChannelAnalysisState:
    ...
    combined_insights = {
        ...
        "shorts_insights": state.get("shorts_insights"),
        "competitor_insights": state.get("competitor_insights"),
        "trend_insights": state.get("trend_insights"),
        "shorts_memory_context": state.get("shorts_memory_context")
    }
    
    system_prompt = """
    You are an expert YouTube Shorts content strategist powered by Hindsight Memory. 
    Based on the provided Shorts insights and the 'shorts_memory_context', generate exactly 10 highly confident Short ideas optimized for reach and engagement.
    ...
    [
      {
        ...
        "description": "Brief description of the Short concept",
        "confidence_score": 95,
        "overall_score": 91,
        "audience_score": 95,
        "historical_score": 88,
        ...
        "memories_used": ["Audience responds well to budget meal prep challenges"],
    ...
    try:
        ...
        state["shorts_recommendations"] = recommendations
    except Exception as e:
        print(f"Error generating Shorts recommendations: {e}")
        state["shorts_recommendations"] = []
